...
public:
     ...
     */
    void setStartTime(QVariant start) {
...
public:
    ...
    cobraTimeline            getCurrentTimeline() const;
    cobraTimeline            getTimeline(int Uid) const;
    cobraMark                getMark(int Uid) const;
...
protected:
    QString                  m_sDBName;
    mutable QSqlDatabase     m_dbDatabase;
